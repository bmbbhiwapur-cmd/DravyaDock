...
# --- CRITICAL FIX: FORCE MATPLOTLIB TO HEADLESS BACKEND TO PREVENT CRASHES ---
import matplotlib
matplotlib.use('Agg') 
...
# --- AYURVEDIC DATABASE LOADER (50 TREES) ---
@st.cache_data
def load_ayurvedic_db():
    hardcoded_data = [
        {"Master ID": "M-001", "Herb / Tree Name": "Tulsi", "Scientific Name": "Ocimum sanctum", "Family": "Lamiaceae", "Phytochemical": "Eugenol", "Canonical SMILES": "COC1=C(O)C=CC(CC=C)=C1", "Medicinal Activity": "Antimicrobial", "Target Protein / Receptor Name": "Secreted Aspartyl Proteinase 1", "PDB ID": "1ZAP", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "तुलसी कटुका तिक्ता हृद्या वृष्या दाहपित्तकृत्। दीपना कुष्ठकृच्छ्रघ्न पार्श्वरुक् कफवातजित्॥", "Roman Transliteration": "tulasī kaṭukā tiktā hṛdyā vṛṣyā dāhapittakṛt", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu, Tikta; Virya: Usna; Vipaka: Katu", "Classical Karma (Action)": "Krimighna (Antimicrobial)"},
        {"Master ID": "M-002", "Herb / Tree Name": "Tulsi", "Scientific Name": "Ocimum sanctum", "Family": "Lamiaceae", "Phytochemical": "Ursolic Acid", "Canonical SMILES": "CC1CCC2(CCC3(C(=CCC4C3(CCC5C4(CCC(C5(C)C)O)C)C)C2C1C)C)C(=O)O", "Medicinal Activity": "Anti-inflammatory", "Target Protein / Receptor Name": "Cyclooxygenase-2 (COX-2)", "PDB ID": "5KIR", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "तुलसी कटुका तिक्ता हृद्या वृष्या दाहपित्तकृत्। दीपना कुष्ठकृच्छ्रघ्न पार्श्वरुक् कफवातजित्॥", "Roman Transliteration": "tulasī kaṭukā tiktā hṛdyā vṛṣyā dāhapittakṛt", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu, Tikta; Virya: Usna; Vipaka: Katu", "Classical Karma (Action)": "Jvaraghna"},
        {"Master ID": "M-003", "Herb / Tree Name": "Haldi (Turmeric)", "Scientific Name": "Curcuma longa", "Family": "Zingiberaceae", "Phytochemical": "Curcumin", "Canonical SMILES": "COC1=CC(=CC=C1O)/C=C/C(=O)CC(=O)/C=C/C2=CC(=C(C=C2)O)OC", "Medicinal Activity": "Anti-inflammatory", "Target Protein / Receptor Name": "Cyclooxygenase-2 (COX-2)", "PDB ID": "5KIR", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "हरिद्रा कटुका तिक्ता रूक्षोष्णा कफपित्तनुत्।", "Roman Transliteration": "haridrā kaṭukā tiktā rūkṣoṣṇā kaphapittanut", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Katu; Virya: Usna; Vipaka: Katu", "Classical Karma (Action)": "Vishaghna, Vranaropana"},
        {"Master ID": "M-004", "Herb / Tree Name": "Haldi (Turmeric)", "Scientific Name": "Curcuma longa", "Family": "Zingiberaceae", "Phytochemical": "Curcumin", "Canonical SMILES": "COC1=CC(=CC=C1O)/C=C/C(=O)CC(=O)/C=C/C2=CC(=C(C=C2)O)OC", "Medicinal Activity": "Anticancer", "Target Protein / Receptor Name": "NF-kappa B Essential Modulator (NEMO)", "PDB ID": "3BRV", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "हरिद्रा कटुका तिक्ता रूक्षोष्णा कफपित्तनुत्।", "Roman Transliteration": "haridrā kaṭukā tiktā rūkṣoṣṇā kaphapittanut", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Katu; Virya: Usna; Vipaka: Katu", "Classical Karma (Action)": "Mehaghna"},
        {"Master ID": "M-005", "Herb / Tree Name": "Ashwagandha", "Scientific Name": "Withania somnifera", "Family": "Solanaceae", "Phytochemical": "Withaferin A", "Canonical SMILES": "CC1=C(C(=O)OC1C2C(CC3C2(CCC4C3CC(C5(C4(C=CC(=O)C5(C)O)C)O)O)C)O)C", "Medicinal Activity": "Neuroprotective", "Target Protein / Receptor Name": "Acetylcholinesterase", "PDB ID": "1EVE", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "अश्वगन्धाऽनिलश्लेष्मश्वित्रशोथक्षयापहा।", "Roman Transliteration": "aśvagandhā'nilaśleṣmaśvitraśothakṣayāpahā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Madhura; Virya: Usna; Vipaka: Madhura", "Classical Karma (Action)": "Rasayana, Balya"},
        {"Master ID": "M-006", "Herb / Tree Name": "Amla", "Scientific Name": "Phyllanthus emblica", "Family": "Phyllanthaceae", "Phytochemical": "Gallic Acid", "Canonical SMILES": "C1=C(C=C(C(=C1O)O)O)C(=O)O", "Medicinal Activity": "Antioxidant", "Target Protein / Receptor Name": "Aldose Reductase", "PDB ID": "1US0", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "आमलकं कषायाम्लं मधुरं शिशिरं लघु।", "Roman Transliteration": "āmalakaṃ kaṣāyāmlaṃ madhuraṃ śiśiraṃ laghu", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Amla Pradhana; Virya: Shita; Vipaka: Madhura", "Classical Karma (Action)": "Rasayana, Pittahara"},
        {"Master ID": "M-007", "Herb / Tree Name": "Amla", "Scientific Name": "Phyllanthus emblica", "Family": "Phyllanthaceae", "Phytochemical": "Quercetin", "Canonical SMILES": "O=C1C(O)=C(C2=CC=C(O)C=C2)OC3=CC(O)=CC(O)=C13", "Medicinal Activity": "Antidiabetic", "Target Protein / Receptor Name": "Alpha-glucosidase", "PDB ID": "3TOP", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "आमलकं कषायाम्लं मधुरं शिशिरं लघु।", "Roman Transliteration": "āmalakaṃ kaṣāyāmlaṃ madhuraṃ śiśiraṃ laghu", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Amla Pradhana; Virya: Shita; Vipaka: Madhura", "Classical Karma (Action)": "Pramehaghna"},
        {"Master ID": "M-008", "Herb / Tree Name": "Kalmegh", "Scientific Name": "Andrographis paniculata", "Family": "Acanthaceae", "Phytochemical": "Andrographolide", "Canonical SMILES": "CC12CCC(C(C1CCC3(C2=CC(OC3=O)C(O)CO)C)O)O", "Medicinal Activity": "Hepatoprotective", "Target Protein / Receptor Name": "Hepatitis C Virus Protease", "PDB ID": "3M5O", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "भूनिम्बः कटुकस्तिक्तः कफपित्तज्वरापहः।", "Roman Transliteration": "bhūnimbaḥ kaṭukastiktaḥ kaphapittajvarāpahaḥ", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Yakrituttejaka"},
        {"Master ID": "M-009", "Herb / Tree Name": "Guggul", "Scientific Name": "Commiphora mukul", "Family": "Burseraceae", "Phytochemical": "Guggulsterone", "Canonical SMILES": "CC12CCC3C(C1CCC2=CC(=O)C)CCC4=CC(=O)CCC34C", "Medicinal Activity": "Hypolipidemic", "Target Protein / Receptor Name": "Farnesoid X Receptor (FXR)", "PDB ID": "1OSV", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "गुग्गुलुः कटुकस्तिक्तो वीर्योष्णः कफवातजित्।", "Roman Transliteration": "gugguluḥ kaṭukastikto vīryoṣṇaḥ kaphavātajit", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Katu; Virya: Usna; Vipaka: Katu", "Classical Karma (Action)": "Medohara"},
        {"Master ID": "M-010", "Herb / Tree Name": "Pippali", "Scientific Name": "Piper longum", "Family": "Piperaceae", "Phytochemical": "Piperine", "Canonical SMILES": "C1CCN(CC1)C(=O)/C=C/C=C/C2=CC3=C(C=C2)OCO3", "Medicinal Activity": "Bioenhancer", "Target Protein / Receptor Name": "Cytochrome P450 3A4", "PDB ID": "1TQN", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "पिप्पली दीपनी वृष्या स्वादुपाका रसायनी।", "Roman Transliteration": "pippalī dīpanī vṛṣyā svādupākā rasāyanī", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu; Virya: Anushna; Vipaka: Madhura", "Classical Karma (Action)": "Rasayana"},
        {"Master ID": "M-011", "Herb / Tree Name": "Sarpagandha", "Scientific Name": "Rauvolfia serpentina", "Family": "Apocynaceae", "Phytochemical": "Reserpine", "Canonical SMILES": "COC1C(CC2CN3CCC4=C(NC5=C4C=CC(=C5)OC)C3CC2C1C(=O)OC)OC(=O)C6=CC(=C(C(=C6)OC)OC)OC", "Medicinal Activity": "Antihypertensive", "Target Protein / Receptor Name": "Vesicular Monoamine Transporter", "PDB ID": "2KBI", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "सर्पगन्धा कटुस्तिक्ता रूक्षोष्णा निद्रदा परा।", "Roman Transliteration": "sarpagandhā kaṭustiktā rūkṣoṣṇā nidradā parā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta; Virya: Usna; Vipaka: Katu", "Classical Karma (Action)": "Nidrajanana"},
        {"Master ID": "M-012", "Herb / Tree Name": "Ardraka (Ginger)", "Scientific Name": "Zingiber officinale", "Family": "Zingiberaceae", "Phytochemical": "6-Gingerol", "Canonical SMILES": "CCCCCC(O)CC(=O)CCC1=CC(=C(O)C=C1)OC", "Medicinal Activity": "Antiemetic", "Target Protein / Receptor Name": "Serotonin 5-HT3 Receptor", "PDB ID": "6Y59", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "आर्द्रकं भेदनि तीक्ष्णं कटुकं रोचनं लघु।", "Roman Transliteration": "ārdrakaṃ bhedani tīkṣṇaṃ kaṭukaṃ rocanaṃ laghu", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu; Virya: Usna; Vipaka: Madhura", "Classical Karma (Action)": "Deepana"},
        {"Master ID": "M-013", "Herb / Tree Name": "Lasuna (Garlic)", "Scientific Name": "Allium sativum", "Family": "Amaryllidaceae", "Phytochemical": "Allicin", "Canonical SMILES": "C=CCSS(=O)CC=C", "Medicinal Activity": "Cardioprotective", "Target Protein / Receptor Name": "HMG-CoA Reductase", "PDB ID": "1HW9", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "लशुनो बृंहणो वृष्यः स्निग्धोष्णः पाचनः सरः।", "Roman Transliteration": "laśuno bṛṃhaṇo vṛṣyaḥ snigdhoṣṇaḥ pācanaḥ saraḥ", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu; Virya: Usna; Vipaka: Katu", "Classical Karma (Action)": "Hridya"},
        {"Master ID": "M-014", "Herb / Tree Name": "Brahmi", "Scientific Name": "Bacopa monnieri", "Family": "Plantaginaceae", "Phytochemical": "Bacoside A", "Canonical SMILES": "CC1=C(C(O)C2(C)C1CCC3C2CC(O)C4(C)C3CCC4C(C)O)C", "Medicinal Activity": "Nootropic", "Target Protein / Receptor Name": "GABA Receptor", "PDB ID": "4COF", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "ब्राह्मी हिमा सरा तिक्ता लघुर्मेध्या च शीतला।", "Roman Transliteration": "brāhmī himā sarā tiktā laghurmedhyā ca śītalā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Kashaya; Virya: Shita; Vipaka: Madhura", "Classical Karma (Action)": "Medhya (Cognitive Enhancer)"},
        {"Master ID": "M-015", "Herb / Tree Name": "Guduchi", "Scientific Name": "Tinospora cordifolia", "Family": "Menispermaceae", "Phytochemical": "Tinosporin", "Canonical SMILES": "O=C1C(O)=C(C2=CC=C(O)C=C2)OC3=CC(O)=CC(O)=C13", "Medicinal Activity": "Immunomodulatory", "Target Protein / Receptor Name": "Macrophage Migration Inhibitory Factor", "PDB ID": "3E8O", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "गुडूची कटुका तिक्ता स्वादुपाका रसायनी।", "Roman Transliteration": "guḍūcī kaṭukā tiktā svādupākā rasāyanī", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Kashaya; Virya: Ushna; Vipaka: Madhura", "Classical Karma (Action)": "Jvaraghna, Rasayana"},
        {"Master ID": "M-016", "Herb / Tree Name": "Shatavari", "Scientific Name": "Asparagus racemosus", "Family": "Asparagaceae", "Phytochemical": "Shatavarin IV", "Canonical SMILES": "CC1CCC2(CCC3(C(=CCC4C3(CCC5C4(CCC(C5(C)C)O)C)C)C2C1C)C)C(=O)O", "Medicinal Activity": "Galactagogue", "Target Protein / Receptor Name": "Prolactin Receptor", "PDB ID": "3O2V", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "शतावरी गुरुः शीता तिक्ता स्वाद्वी रसायनी।", "Roman Transliteration": "śatāvarī guruḥ śītā tiktā svādvī rasāyanī", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Madhura, Tikta; Virya: Shita; Vipaka: Madhura", "Classical Karma (Action)": "Vrishya, Stanyajanana"},
        {"Master ID": "M-017", "Herb / Tree Name": "Haritaki", "Scientific Name": "Terminalia chebula", "Family": "Combretaceae", "Phytochemical": "Chebulinic acid", "Canonical SMILES": "C1=C(C=C(C(=C1O)O)O)C(=O)O", "Medicinal Activity": "Laxative / Prokinetic", "Target Protein / Receptor Name": "5-HT4 Receptor", "PDB ID": "6HJP", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "हरीतकी पञ्चरसा अलवणा तुवरा शिवा।", "Roman Transliteration": "harītakī pañcarasā alavaṇā tuvarā śivā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Pancharasa; Virya: Ushna; Vipaka: Madhura", "Classical Karma (Action)": "Anulomana, Rasayana"},
        {"Master ID": "M-018", "Herb / Tree Name": "Bibhitaki", "Scientific Name": "Terminalia bellirica", "Family": "Combretaceae", "Phytochemical": "Gallic Acid", "Canonical SMILES": "C1=C(C=C(C(=C1O)O)O)C(=O)O", "Medicinal Activity": "Antitussive", "Target Protein / Receptor Name": "Histamine H1 Receptor", "PDB ID": "3RZE", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "बिभीतकं स्वादुपाकं कषायं कफपित्तनुत्।", "Roman Transliteration": "bibhītakaṃ svādupākaṃ kaṣāyaṃ kaphapittanut", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Kashaya; Virya: Ushna; Vipaka: Madhura", "Classical Karma (Action)": "Kasahara"},
        {"Master ID": "M-019", "Herb / Tree Name": "Arjuna", "Scientific Name": "Terminalia arjuna", "Family": "Combretaceae", "Phytochemical": "Arjunolic acid", "Canonical SMILES": "CC1CCC2(CCC3(C(=CCC4C3(CCC5C4(CCC(C5(C)C)O)C)C)C2C1C)C)C(=O)O", "Medicinal Activity": "Cardioprotective", "Target Protein / Receptor Name": "Beta-1 Adrenergic Receptor", "PDB ID": "2Y02", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "अर्जुनो हृदयो वर्ण्यः कषायो मधुराः शीतः।", "Roman Transliteration": "arjuno hṛdayo varṇyaḥ kaṣāyo madhurāḥ śītaḥ", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Kashaya; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Hridya"},
        {"Master ID": "M-020", "Herb / Tree Name": "Gokshura", "Scientific Name": "Tribulus terrestris", "Family": "Zygophyllaceae", "Phytochemical": "Protodioscin", "Canonical SMILES": "CC1CCC2(CCC3(C(=CCC4C3(CCC5C4(CCC(C5(C)C)O)C)C)C2C1C)C)C(=O)O", "Medicinal Activity": "Diuretic", "Target Protein / Receptor Name": "Carbonic Anhydrase", "PDB ID": "1AZM", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "गोक्षुरो मूत्रकृच्छ्रघ्नः प्रमेहानिलनाशकः।", "Roman Transliteration": "gokṣuro mūtrakṛcchraghnaḥ pramehānilanāśakaḥ", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Madhura; Virya: Shita; Vipaka: Madhura", "Classical Karma (Action)": "Mutrala"},
        {"Master ID": "M-021", "Herb / Tree Name": "Punarnava", "Scientific Name": "Boerhavia diffusa", "Family": "Nyctaginaceae", "Phytochemical": "Punarnavine", "Canonical SMILES": "COC1=C(OC)C2=C(CC3=C(C=C4OCOC4=C3)C=[N+]2C)C=C1", "Medicinal Activity": "Anti-edematous", "Target Protein / Receptor Name": "Renin", "PDB ID": "2V0Z", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "पुनर्नवा भवेदुष्णा तिक्ता रूक्षा कफापहा।", "Roman Transliteration": "punarnavā bhaveduṣṇā tiktā rūkṣā kaphāpahā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Shothahara"},
        {"Master ID": "M-022", "Herb / Tree Name": "Vasa", "Scientific Name": "Adhatoda vasica", "Family": "Acanthaceae", "Phytochemical": "Vasicine", "Canonical SMILES": "C1CN2CC3=C(C2=C1)NC=C3", "Medicinal Activity": "Bronchodilator", "Target Protein / Receptor Name": "Phosphodiesterase 4", "PDB ID": "1RO6", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "वासा तिक्ता कषाया च शीतला रक्तपित्तजित्।", "Roman Transliteration": "vāsā tiktā kaṣāyā ca śītalā raktapittajit", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Kashaya; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Shvasahara"},
        {"Master ID": "M-023", "Herb / Tree Name": "Kantakari", "Scientific Name": "Solanum virginianum", "Family": "Solanaceae", "Phytochemical": "Solasodine", "Canonical SMILES": "CC1CCC2(CCC3(C(=CCC4C3(CCC5C4(CCC(C5(C)C)O)C)C)C2C1C)C)C(=O)O", "Medicinal Activity": "Expectorant", "Target Protein / Receptor Name": "Muscarinic M3 Receptor", "PDB ID": "4DAJ", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "कण्टकारी कटुस्तिक्ता सोष्णा श्वासकासजित्।", "Roman Transliteration": "kaṇṭakārī kaṭustiktā soṣṇā śvāsakāsajit", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu, Tikta; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Kasahara"},
        {"Master ID": "M-024", "Herb / Tree Name": "Bhringaraj", "Scientific Name": "Eclipta alba", "Family": "Asteraceae", "Phytochemical": "Wedelolactone", "Canonical SMILES": "O=C1C(O)=C(C2=CC=C(O)C=C2)OC3=CC(O)=CC(O)=C13", "Medicinal Activity": "Hepatoprotective", "Target Protein / Receptor Name": "Cytochrome P450", "PDB ID": "1TQN", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "भृङ्गराजः कटुस्तिक्तो रूक्षोष्णः कफवातजित्।", "Roman Transliteration": "bhṛṅgarājaḥ kaṭustikto rūkṣoṣṇaḥ kaphavātajit", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu, Tikta; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Keshya, Yakrituttejaka"},
        {"Master ID": "M-025", "Herb / Tree Name": "Manjistha", "Scientific Name": "Rubia cordifolia", "Family": "Rubiaceae", "Phytochemical": "Purpurin", "Canonical SMILES": "O=C1C2=C(C(=O)C3=C1C=CC=C3)C(O)=C(O)C(O)=C2", "Medicinal Activity": "Blood Purifier", "Target Protein / Receptor Name": "Human Serum Albumin", "PDB ID": "1AO6", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "मञ्जिष्ठा मधुरा तिक्ता कषाया स्वरवर्णकृत्।", "Roman Transliteration": "mañjiṣṭhā madhurā tiktā kaṣāyā svaravarṇakṛt", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Kashaya; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Raktashodhaka"},
        {"Master ID": "M-026", "Herb / Tree Name": "Neem", "Scientific Name": "Azadirachta indica", "Family": "Meliaceae", "Phytochemical": "Nimbin", "Canonical SMILES": "CC(=O)OC1C(C2(CC3C(C24C1C(O4)C(=C)C(=O)OC)CC(C5(C3CC(O5)C6=COCO6)C)OC(=O)C)C)C", "Medicinal Activity": "Antibacterial", "Target Protein / Receptor Name": "Penicillin-Binding Protein 2a", "PDB ID": "1VQQ", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "निम्बः शीतो लघुस्तिक्तो व्रणशोधनरोपणः।", "Roman Transliteration": "nimbaḥ śīto laghustikto vraṇaśodhanaropaṇaḥ", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Kashaya; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Krimighna"},
        {"Master ID": "M-027", "Herb / Tree Name": "Kutki", "Scientific Name": "Picrorhiza kurroa", "Family": "Plantaginaceae", "Phytochemical": "Picroside I", "Canonical SMILES": "COC1=CC(=CC=C1O)/C=C/C(=O)CC(=O)/C=C/C2=CC(=C(C=C2)O)OC", "Medicinal Activity": "Hepatoprotective", "Target Protein / Receptor Name": "Hepatitis B Virus Protease", "PDB ID": "2M5O", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "कुटकी कटुका तिक्ता कफपित्तज्वरापहा।", "Roman Transliteration": "kuṭakī kaṭukā tiktā kaphapittajvarāpahā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Bhedana, Yakrituttejaka"},
        {"Master ID": "M-028", "Herb / Tree Name": "Chitrak", "Scientific Name": "Plumbago zeylanica", "Family": "Plumbaginaceae", "Phytochemical": "Plumbagin", "Canonical SMILES": "CC1=C(C(=O)C2=CC=CC=C2C1=O)O", "Medicinal Activity": "Digestive Stimulant", "Target Protein / Receptor Name": "Pancreatic Lipase", "PDB ID": "1LPB", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "चित्रकः कटुकः पाके वह्निकृत्पाचनो लघुः।", "Roman Transliteration": "citrakaḥ kaṭukaḥ pāke vahnikṛtpācano laghuḥ", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Deepana, Pachana"},
        {"Master ID": "M-029", "Herb / Tree Name": "Daruharidra", "Scientific Name": "Berberis aristata", "Family": "Berberidaceae", "Phytochemical": "Berberine", "Canonical SMILES": "COC1=C(OC)C2=C(CC3=C(C=C4OCOC4=C3)C=[N+]2C)C=C1", "Medicinal Activity": "Antimicrobial", "Target Protein / Receptor Name": "DNA Gyrase", "PDB ID": "1KZN", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "दार्वी तिक्ता कषाया च रूक्षोष्णा व्रणमेहनुत्।", "Roman Transliteration": "dārvī tiktā kaṣāyā ca rūkṣoṣṇā vraṇamehanut", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Kashaya; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Krimighna"},
        {"Master ID": "M-030", "Herb / Tree Name": "Musta", "Scientific Name": "Cyperus rotundus", "Family": "Cyperaceae", "Phytochemical": "Cyperene", "Canonical SMILES": "CC1=C(C(=O)OC1C2C(CC3C2(CCC4C3CC(C5(C4(C=CC(=O)C5(C)O)C)O)O)C)O)C", "Medicinal Activity": "Antispasmodic", "Target Protein / Receptor Name": "Phosphodiesterase 4", "PDB ID": "1RO6", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "मुस्तं कटु हिमं ग्राहि तिक्तं दीपनपाचनम्।", "Roman Transliteration": "mustaṃ kaṭu himaṃ grāhi tiktaṃ dīpanapācanam", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Katu, Kashaya; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Pachana, Grahi"},
        {"Master ID": "M-031", "Herb / Tree Name": "Vidanga", "Scientific Name": "Embelia ribes", "Family": "Primulaceae", "Phytochemical": "Embelin", "Canonical SMILES": "CCCCCCCCCCC1=C(C(=O)C(=C(C1=O)O)O)O", "Medicinal Activity": "Anthelmintic", "Target Protein / Receptor Name": "Tubulin", "PDB ID": "1TUB", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "विडङ्गं कटु तीक्ष्णोष्णं रूक्षं वह्निकरं लघु।", "Roman Transliteration": "viḍaṅgaṃ kaṭu tīkṣṇoṣṇaṃ rūkṣaṃ vahnikaraṃ laghu", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Krimighna"},
        {"Master ID": "M-032", "Herb / Tree Name": "Sariva", "Scientific Name": "Hemidesmus indicus", "Family": "Apocynaceae", "Phytochemical": "Hemidesmin", "Canonical SMILES": "COC1=C(C=CC(=C1)C=O)O", "Medicinal Activity": "Blood Purifier", "Target Protein / Receptor Name": "Human Serum Albumin", "PDB ID": "1AO6", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "सारिवा मधुरा शीता सुगन्धा कुष्ठनाशनी।", "Roman Transliteration": "sārivā madhurā śītā sugandhā kuṣṭhanāśanī", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Madhura; Virya: Shita; Vipaka: Madhura", "Classical Karma (Action)": "Raktashodhaka"},
        {"Master ID": "M-033", "Herb / Tree Name": "Kumari", "Scientific Name": "Aloe vera", "Family": "Asphodelaceae", "Phytochemical": "Aloin", "Canonical SMILES": "O=C1C(O)=C(C2=CC=C(O)C=C2)OC3=CC(O)=CC(O)=C13", "Medicinal Activity": "Laxative", "Target Protein / Receptor Name": "Guanylate Cyclase", "PDB ID": "1AW9", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "कुमारी भेदिनी शीता तिक्ता नेत्रा रसायनी।", "Roman Transliteration": "kumārī bhedinī śītā tiktā netrā rasāyanī", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Madhura; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Bhedana, Rasayana"},
        {"Master ID": "M-034", "Herb / Tree Name": "Kapikacchu", "Scientific Name": "Mucuna pruriens", "Family": "Fabaceae", "Phytochemical": "L-DOPA", "Canonical SMILES": "C1=CC(=C(C=C1CC(C(=O)O)N)O)O", "Medicinal Activity": "Neuroprotective / Aphrodisiac", "Target Protein / Receptor Name": "Dopamine D2 Receptor", "PDB ID": "6CM4", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "कपिकच्छूर्भृशं वृष्या मधुरा बृंहणी गुरुः।", "Roman Transliteration": "kapikacchūrbhṛśaṃ vṛṣyā madhurā bṛṃhaṇī guruḥ", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Madhura; Virya: Ushna; Vipaka: Madhura", "Classical Karma (Action)": "Vrishya"},
        {"Master ID": "M-035", "Herb / Tree Name": "Bakuchi", "Scientific Name": "Psoralea corylifolia", "Family": "Fabaceae", "Phytochemical": "Psoralen", "Canonical SMILES": "C1=CC2=C(C=C1)C=CC(=O)O2", "Medicinal Activity": "Anti-vitiligo", "Target Protein / Receptor Name": "Tyrosinase", "PDB ID": "1WX2", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "बाकुची कटुतिक्तोष्णा कृमिकुष्ठकफापहा।", "Roman Transliteration": "bākucī kaṭutiktoṣṇā kṛmikuṣṭhakaphāpahā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu, Tikta; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Kushthaghna"},
        {"Master ID": "M-036", "Herb / Tree Name": "Jyotishmati", "Scientific Name": "Celastrus paniculatus", "Family": "Celastraceae", "Phytochemical": "Celastrine", "Canonical SMILES": "COC1=C(OC)C2=C(CC3=C(C=C4OCOC4=C3)C=[N+]2C)C=C1", "Medicinal Activity": "Cognitive Enhancer", "Target Protein / Receptor Name": "Acetylcholinesterase", "PDB ID": "1EVE", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "ज्योतिष्मती कटुस्तिक्ता सरोष्णा कफवातजित्।", "Roman Transliteration": "jyotiṣmatī kaṭustiktā saroṣṇā kaphavātajit", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu, Tikta; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Medhya"},
        {"Master ID": "M-037", "Herb / Tree Name": "Shalaparni", "Scientific Name": "Desmodium gangeticum", "Family": "Fabaceae", "Phytochemical": "Gangetin", "Canonical SMILES": "O=C1C(O)=C(C2=CC=C(O)C=C2)OC3=CC(O)=CC(O)=C13", "Medicinal Activity": "Anti-inflammatory", "Target Protein / Receptor Name": "Cyclooxygenase-2 (COX-2)", "PDB ID": "5KIR", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "शालपर्णी गुरुश्छर्दिज्वरश्वासनिषूदनी।", "Roman Transliteration": "śālaparṇī guruśchardijvaraśvāsaniṣūdanī", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Madhura, Tikta; Virya: Ushna; Vipaka: Madhura", "Classical Karma (Action)": "Angamardaprashamana"},
        {"Master ID": "M-038", "Herb / Tree Name": "Prishniparni", "Scientific Name": "Uraria picta", "Family": "Fabaceae", "Phytochemical": "Urariol", "Canonical SMILES": "COC1=C(O)C=CC(CC=C)=C1", "Medicinal Activity": "Fracture Healing", "Target Protein / Receptor Name": "Osteocalcin", "PDB ID": "1Q8H", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "पृश्निपर्णी त्रिदोषघ्नी वृष्याष्ण्णा मधुरा सरा।", "Roman Transliteration": "pṛśniparṇī tridoṣaghnī vṛṣyāṣṇṇā madhurā sarā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Madhura, Tikta; Virya: Ushna; Vipaka: Madhura", "Classical Karma (Action)": "Sandhaniya"},
        {"Master ID": "M-039", "Herb / Tree Name": "Brihati", "Scientific Name": "Solanum indicum", "Family": "Solanaceae", "Phytochemical": "Solasodine", "Canonical SMILES": "CC1CCC2(CCC3(C(=CCC4C3(CCC5C4(CCC(C5(C)C)O)C)C)C2C1C)C)C(=O)O", "Medicinal Activity": "Expectorant", "Target Protein / Receptor Name": "Muscarinic M3 Receptor", "PDB ID": "4DAJ", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "बृहती ग्राहिणी कुष्ठज्वरश्वासकफापहा।", "Roman Transliteration": "bṛhatī grāhiṇī kuṣṭhajvaraśvāsakaphāpahā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu, Tikta; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Kasahara"},
        {"Master ID": "M-040", "Herb / Tree Name": "Agnimantha", "Scientific Name": "Clerodendrum phlomidis", "Family": "Lamiaceae", "Phytochemical": "Pectolinarigenin", "Canonical SMILES": "O=C1C(O)=C(C2=CC=C(O)C=C2)OC3=CC(O)=CC(O)=C13", "Medicinal Activity": "Anti-inflammatory", "Target Protein / Receptor Name": "Lipoxygenase", "PDB ID": "3O8Y", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "अग्निमन्थः श्वयथुहा वीर्योष्णः कफवातहा।", "Roman Transliteration": "agnimanthaḥ śvayathuhā vīryoṣṇaḥ kaphavātahā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Katu, Kashaya; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Shothahara"},
        {"Master ID": "M-041", "Herb / Tree Name": "Shyonaka", "Scientific Name": "Oroxylum indicum", "Family": "Bignoniaceae", "Phytochemical": "Oroxylin A", "Canonical SMILES": "COC1=C(O)C=CC(CC=C)=C1", "Medicinal Activity": "Anticancer", "Target Protein / Receptor Name": "DNA Topoisomerase II", "PDB ID": "1ZXM", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "श्योनाकः दीपनः पाके कटुकः तुवरो हिमः।", "Roman Transliteration": "śyonākaḥ dīpanaḥ pāke kaṭukaḥ tuvaro himaḥ", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Kashaya; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Deepana, Pachana"},
        {"Master ID": "M-042", "Herb / Tree Name": "Patala", "Scientific Name": "Stereospermum suaveolens", "Family": "Bignoniaceae", "Phytochemical": "Lapachol", "Canonical SMILES": "CC(=C)CC1=C(O)C(=O)C2=CC=CC=C2C1=O", "Medicinal Activity": "Wound Healing", "Target Protein / Receptor Name": "Collagenase", "PDB ID": "1CGL", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "पाटला तुवरा तिक्ता अनुष्णा कफवातनुत्।", "Roman Transliteration": "pāṭalā tuvarā tiktā anuṣṇā kaphavātanut", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Kashaya; Virya: Anushna; Vipaka: Katu", "Classical Karma (Action)": "Vranaropana"},
        {"Master ID": "M-043", "Herb / Tree Name": "Gambhari", "Scientific Name": "Gmelina arborea", "Family": "Lamiaceae", "Phytochemical": "Gmelinol", "Canonical SMILES": "COC1=CC(=CC=C1O)/C=C/C(=O)CC(=O)/C=C/C2=CC(=C(C=C2)O)OC", "Medicinal Activity": "Lactogenic", "Target Protein / Receptor Name": "Prolactin Receptor", "PDB ID": "3O2V", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "गम्भारी भृशमुष्णा च गुर्वी दोषत्रयापहा।", "Roman Transliteration": "gambhārī bhṛśamuṣṇā ca gurvī doṣatrayāpahā", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Kashaya, Madhura; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Stanyajanana"},
        {"Master ID": "M-044", "Herb / Tree Name": "Bilva", "Scientific Name": "Aegle marmelos", "Family": "Rutaceae", "Phytochemical": "Marmelosin", "Canonical SMILES": "CC1=C(C(=O)OC1C2C(CC3C2(CCC4C3CC(C5(C4(C=CC(=O)C5(C)O)C)O)O)C)O)C", "Medicinal Activity": "Antidiarrheal", "Target Protein / Receptor Name": "Guanylate Cyclase", "PDB ID": "1AW9", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "बिल्वं तु ग्राहि रूक्षोष्णं दीपनं कफवातजित्।", "Roman Transliteration": "bilvaṃ tu grāhi rūkṣoṣṇaṃ dīpanaṃ kaphavātajit", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Kashaya, Tikta; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Grahi"},
        {"Master ID": "M-045", "Herb / Tree Name": "Shalmali", "Scientific Name": "Bombax ceiba", "Family": "Malvaceae", "Phytochemical": "Lupeol", "Canonical SMILES": "CC1CCC2(CCC3(C(=CCC4C3(CCC5C4(CCC(C5(C)C)O)C)C)C2C1C)C)C(=O)O", "Medicinal Activity": "Astringent", "Target Protein / Receptor Name": "Trypsin", "PDB ID": "1AQ7", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "शाल्मली शीतला स्वाद्वी रसपाके रसायनी।", "Roman Transliteration": "śālmalī śītalā svādvī rasapāke rasāyanī", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Madhura; Virya: Shita; Vipaka: Madhura", "Classical Karma (Action)": "Stambhana"},
        {"Master ID": "M-046", "Herb / Tree Name": "Palasha", "Scientific Name": "Butea monosperma", "Family": "Fabaceae", "Phytochemical": "Butein", "Canonical SMILES": "C1=CC(=C(C=C1C=CC(=O)C2=C(C=C(C=C2)O)O)O)O", "Medicinal Activity": "Anthelmintic", "Target Protein / Receptor Name": "Nematode Beta-Tubulin", "PDB ID": "1TUB", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "पलाशो दीपनो वृष्यः सरोष्णो व्रणगुल्मजित्।", "Roman Transliteration": "palāśo dīpano vṛṣyaḥ saroṣṇo vraṇagulmajit", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu, Tikta, Kashaya; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Krimighna"},
        {"Master ID": "M-047", "Herb / Tree Name": "Ashoka", "Scientific Name": "Saraca asoca", "Family": "Fabaceae", "Phytochemical": "Ketosterol", "Canonical SMILES": "CC12CCC3C(C1CCC2=CC(=O)C)CCC4=CC(=O)CCC34C", "Medicinal Activity": "Uterine Tonic", "Target Protein / Receptor Name": "Estrogen Receptor Alpha", "PDB ID": "1A52", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "अशोको हेमपुष्पश्च वञ्जुलो दोषनाशकः।", "Roman Transliteration": "aśoko hemapuṣpaśca vañjulo doṣanāśakaḥ", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Kashaya, Tikta; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Garbhashaya Balya"},
        {"Master ID": "M-048", "Herb / Tree Name": "Lodhra", "Scientific Name": "Symplocos racemosa", "Family": "Symplocaceae", "Phytochemical": "Loturine", "Canonical SMILES": "COC1=C(OC)C2=C(CC3=C(C=C4OCOC4=C3)C=[N+]2C)C=C1", "Medicinal Activity": "Hemostatic", "Target Protein / Receptor Name": "Thrombin", "PDB ID": "1BBR", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "लोध्रो ग्राही लघुः शीतश्चक्षुष्यः कफपित्तनुत्।", "Roman Transliteration": "lodhro grāhī laghuḥ śītaścakṣuṣyaḥ kaphapittanut", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Kashaya; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Stambhana"},
        {"Master ID": "M-049", "Herb / Tree Name": "Kutaja", "Scientific Name": "Holarrhena antidysenterica", "Family": "Apocynaceae", "Phytochemical": "Conessine", "Canonical SMILES": "CC1CCC2(CCC3(C(=CCC4C3(CCC5C4(CCC(C5(C)C)O)C)C)C2C1C)C)C(=O)O", "Medicinal Activity": "Anti-amoebic", "Target Protein / Receptor Name": "Entamoeba histolytica Cysteine Proteinase", "PDB ID": "1F2A", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "कुटजः कटुको रूक्षो दीपनो कफपित्तनुत्।", "Roman Transliteration": "kuṭajaḥ kaṭuko rūkṣo dīpano kaphapittanut", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Tikta, Kashaya; Virya: Shita; Vipaka: Katu", "Classical Karma (Action)": "Atisarahara"},
        {"Master ID": "M-050", "Herb / Tree Name": "Vacha", "Scientific Name": "Acorus calamus", "Family": "Acoraceae", "Phytochemical": "Asarone", "Canonical SMILES": "CC=CC1=CC(=C(C=C1OC)OC)OC", "Medicinal Activity": "Nootropic", "Target Protein / Receptor Name": "GABA Receptor", "PDB ID": "4COF", "Sanskrit Shloka (Bhavaprakasha Nighantu)": "वचा कटुर्विपाके च तीक्ष्णोष्णा कफवातजित्।", "Roman Transliteration": "vacā kaṭurvipāke ca tīkṣṇoṣṇā kaphavātajit", "Dravyaguna Profile (Rasa/Virya/Vipaka)": "Rasa: Katu, Tikta; Virya: Ushna; Vipaka: Katu", "Classical Karma (Action)": "Medhya, Sangyasthapana"}
    ]
...
with col_params:
    ...
    if st.button("📥 Load Target & Ligand from Database", type="primary", use_container_width=True):
        with st.spinner("Fetching PDB & Converting SMILES to 3D Space..."):
            ...
            if success:
                ...
                st.error(f"Failed to fetch PDB {pdb_id}")
            
            ok, msg = convert_smiles_to_pdbqt(smiles_str, "ligand.pdbqt")
            if ok:
            ...
            if st.session_state.target_ready and st.session_state.ligand_ready:
                st.success("Target and Ligand successfully mounted from Database!")
                trigger_rerun = True
    ...
    if st.session_state.target_ready and st.session_state.local_target_path:
        ...
        if bound_ligands_list:
            st.subheader("2. Bound Small Molecules in Receptor")
    ...
    st.subheader("3. Search Space Mechanics (Grid Box)")
...
with col_visual:
    st.subheader("4. Active Viewport Canvas")
