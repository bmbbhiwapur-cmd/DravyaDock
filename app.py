...
def load_ayurvedic_db():
    # Safely reference the file verbatim
    file_path = "Ayurvedic_Phytochemical_Sanskrit_Master_Database_V2.csv"
    
    # 50-Tree Master Database Embedded directly to prevent CSV Parser Errors
    hardcoded_data = [
