...
# --- NEW: AYURVEDIC DATABASE LOADER ---
@st.cache_data
def load_ayurvedic_db():
    # Fallback dummy data structurally matched to your provided CSV
    dummy_data = [
